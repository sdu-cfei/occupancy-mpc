...
emu_horizon = 480     # optimization horizon, integer, number of minutes, must be a multiple of emu_step -- WE CHANGE ONLY THIS BETWEEN CASES
...
for zone in zones:
    ...
    # Output directory
    out = os.path.join('new_results', 'mpc_predicted_occ_v2', '{}_qr_200'.format(emu_horizon), zone)
